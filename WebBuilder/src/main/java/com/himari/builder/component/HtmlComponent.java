...
public class HtmlComponent implements ExpandableComponent {
    ...
    public void setIdentifier(String identifier) {
        throw new UnsupportedOperationException("Operation of setting the identifier is not supported in html component.");
    }
