...
package com.himari.builder.component.header;
...
public class HeaderComponent implements ExpandableComponent {
    ...
    public void setIdentifier(String identifier) {
        throw new UnsupportedOperationException("Operation of setting the identifier is not supported in header component.");
    }
